Shader "GreenLeaves_Custom/GrabPassDistortion"
{
	Properties
	{
		...
		SubShader
		{
			//cull off so that the effect wrks when we look at the object from the back
			//blend srcalpha oneminussrcalpha which are standard to transparency are 
			//excluded because they cause artifacts in combination with cull off
