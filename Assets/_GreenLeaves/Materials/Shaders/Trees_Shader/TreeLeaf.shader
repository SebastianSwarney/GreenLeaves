Shader "GreenLeaves_Custom/TreeLeafShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf Tree fullforwardshadows addshadow //addshadow allows the leaves that are clippsed to cast a matching shadow
